...
local themeStyles = {
	...
	Serpent = {
		SchemeColor = Color3.fromRGB(170, 170, 255),
		Background = Color3.fromRGB(255, 255, 255),
...
function Kavo.CreateLib(kavName, themeList)
	...
	elseif themeList == "Serpent" then
		themeList = themeStyles.HexHub
	elseif themeList == "HexHub" then
		themeList = themeStyles.HexHub
	else
	...
	MainCorner.CornerRadius = UDim.new(0.02, 7)
	...
	headerCover.CornerRadius = UDim.new(0.02, 7)
...
--Custom NotificationLib

-- Made By Hexer & Oliver, HexHub On Top

--Notification Container (To fix notification overlaping since you retards kept complaining)

local HexNotif = Instance.new("ScreenGui")
local NotificationContainer = Instance.new("Frame")
local UIListLayout = Instance.new("UIListLayout")

HexNotif.Name = "HexNotif"
HexNotif.Parent = game.Players.LocalPlayer.PlayerGui
HexNotif.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

NotificationContainer.Name = "NotificationContainer"
NotificationContainer.Parent = HexNotif
NotificationContainer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
NotificationContainer.BackgroundTransparency = 1.000
NotificationContainer.Position = UDim2.new(0.841212094, 0, 0.903, 0)
NotificationContainer.Size = UDim2.new(0, 304, 0, 68)
...
function Notify(Title,Desc,Icon,SoundID) -- Changed time to sound id so you can have custon notification sounds if you want to use this shit.
	...
	NFrame.Name = "NFrame"
	NFrame.Parent = game.Players.LocalPlayer.PlayerGui.HexNotif.NotificationContainer
	NFrame.BackgroundColor3 = Color3.fromRGB(170, 170, 255)
	...
	NIcon.Name = "Icon"
	NIcon.Parent = NFrame
	NIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	NIcon.BackgroundTransparency = 1.000
	NIcon.BorderColor3 = Color3.fromRGB(27, 42, 53)
	NIcon.Position = UDim2.new(0.0291261375, 0, 0.112058759, 0)
	NIcon.Size = UDim2.new(0,0,0,0)
	NIcon.Image = "rbxasset://0"

	NICorner.CornerRadius = UDim.new(0.200000003, 2)
	NICorner.Name = "NICorner"
	NICorner.Parent = NIcon

	NTitle.Name = "NTitle"
	NTitle.Parent = NFrame
	NTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	NTitle.BackgroundTransparency = 1.000
	NTitle.Position = UDim2.new(0.225913629, 0, 0.0597014427, 0)
	NTitle.Size = UDim2.new(0,0,0,0)
	NTitle.Font = Enum.Font.FredokaOne
	NTitle.Text = "Text"
	...
	NDesc.Name = "NDesc"
	NDesc.Parent = NFrame
	NDesc.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	NDesc.BackgroundTransparency = 1.000
	NDesc.Position = UDim2.new(0.225913629, 0, 0.408951879, 0)
	NDesc.Size = UDim2.new(0,0,0,0)
	NDesc.Font = Enum.Font.FredokaOne
	NDesc.Text = "Text"
	NDesc.TextColor3 = Color3.fromRGB(255, 255, 255)
	NDesc.TextScaled = true
	NDesc.TextSize = 14.000
	NDesc.TextWrapped = true
	
	NSound.Name = "NotifSoundFX"
	NSound.Parent = NFrame
	
	
	NSound.Looped = false
NSound.PlaybackSpeed = 1
	NSound.Volume = .8
	NSound.Playing = false

	
	
	-- Setting Notification Values
	
	NSound.SoundId = "rbxassetid://".. tostring(SoundID)
	...
	-- Sending Notification/Loading Tween Value(s)
	NSound:Play()
	NFrame:TweenSize(UDim2.new(0, 301, 0, 67),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NDesc:TweenSize(UDim2.new(0, 225, 0, 35),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NTitle:TweenSize(UDim2.new(0, 225, 0, 23),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NIcon:TweenSize(UDim2.new(0, 50, 0, 50),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	wait(4)
	NFrame:TweenSize(UDim2.new(0, 0, 0, 0),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NDesc:TweenSize(UDim2.new(0, 0, 0, 0),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NTitle:TweenSize(UDim2.new(0, 0, 0, 0),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	NIcon:TweenSize(UDim2.new(0, 0, 0, 0),Enum.EasingDirection.InOut,Enum.EasingStyle.Quad,0.5)
	...
	-- Notification Done, Ready for next use
